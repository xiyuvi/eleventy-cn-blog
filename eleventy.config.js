...
module.exports = function (eleventyConfig) {
	...
	//url编码（不需要编码，url本身就支持中文泰文日文）
	eleventyConfig.addFilter("encode", function filterTagList(url) {
	...
	//
	eleventyConfig.addFilter("filterCategories", function filterTagList(tags) {
